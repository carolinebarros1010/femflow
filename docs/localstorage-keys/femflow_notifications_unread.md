# femflow_notifications_unread

## Resumo
Chave de estado `femflow_notifications_unread` usada pelo app FemFlow para controle de fluxo, sessão e experiência da usuária.
